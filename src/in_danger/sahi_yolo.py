...
class ModifiedUltralyticsDetectionModel(DetectionModel):
    def __init__(
        self,
        model_path,
        task,
        ...
        super().__init__(
            ...
            device=prediction_args["device"],
            confidence_threshold=prediction_args["conf"],
        )
    ...
    def perform_inference(self, image: np.ndarray):
        ...
        prediction_result = self.model.predict(source=image, **self.prediction_args)
