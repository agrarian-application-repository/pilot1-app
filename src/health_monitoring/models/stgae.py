...
class EncoderSpatial(nn.Module):
    ...
    def __init__(self,
        ...
        self.embedding_layer = GCNConv(in_channels=self.input_size, out_channels=self.embedding_size,
                                       add_self_loops=True)
    ...
    def forward(self, x: torch.FloatTensor):
        ...
        graph_input, edge_index, edge_weight = self.preprocess_data_spatio_temporal_graph(x, agents_per_sample, T=nT,
                                                                                          F=nF)
